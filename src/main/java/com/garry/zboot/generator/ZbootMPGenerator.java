...
public class ZbootMPGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.garry.zboot.modules.meet.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.garry.zboot.modules.meet.dao.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.garry.zboot.modules.meet.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.garry.zboot.modules.meet.service.impl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.garry.zboot.modules.meet.controller";
